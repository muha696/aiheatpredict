...
data['month'] = data['datetime'].dt.minute
...
new_data['date_only'] = new_data['datetime'].dt.date    #Удаление дат где не было измерений в течении всего дня
...
features = ['tair_sc', 'day_sc', 'hour_sin', 'hour_cos', 'hour_sc', 'is_weekend', 'month_sc',]
...
y_test_real = scaler_y.inverse_transform(y.reshape(-1, 1)).flatten()
